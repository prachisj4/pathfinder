export default function ResultsPage({ user, results, navigate }) {
  ...
  const colors = ["#FF0080", "#00DFD8", "#F5A623"];
    ...
    <div style={{
      ...
      <div style={{ maxWidth: "860px", margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px", marginBottom: "40px" }}>
          {careers.map((c, i) => (
            <div key={i} className="result-card" style={{
              background: colorsBg[i] || "rgba(255,255,255,0.03)",
              border: `1px solid ${colorsBorder[i] || "rgba(255,255,255,0.12)"}`,
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "12px" }}>
                <div>
                  <div style={{
                    display: "inline-block", background: colors[i] || "#FF0080",
                    color: "white", borderRadius: "8px", padding: "3px 10px",
                    fontSize: "12px", fontWeight: 600, marginBottom: "8px"
                  }}>#{i + 1} Match</div>
                  <h3 style={{ fontFamily: "'Outfit', sans-serif", fontSize: "22px", fontWeight: 700, margin: 0 }}>
                    {c.title}
                  </h3>
                </div>
                <div style={{
                  ...
                  <div style={{ fontSize: "24px", fontWeight: 700, color: colors[i] || "#FF0080" }}>
                    {c.matchScore}%
                  </div>
              ...
              <div style={{ background: "rgba(0,0,0,0.3)", borderRadius: "100px", height: "6px", marginBottom: "16px" }}>
                <div style={{
                  ...
                  background: colors[i] || "#FF0080", borderRadius: "100px"
                }} />
              </div>
            ...
            <div key={i} style={{ marginBottom: i < skillsGap.length - 1 ? "20px" : 0 }}>
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "8px" }}>
                ...
                <span style={{
                  ...
                  color: sg.status === "Have" ? "#00DFD8" : "#F5A623"
                }}>{sg.status}</span>
              </div>
              <div style={{ background: "rgba(255,255,255,0.12)", borderRadius: "100px", height: "8px" }}>
                <div style={{
                  width: `${sg.level}%`, height: "100%",
                  background: sg.status === "Have"
                    ? "linear-gradient(90deg, #00DFD8, #059669)"
          ...
          {roadmap.map((r, i) => (
            <div key={i} style={{
              ...
              <div style={{
                ...
                <div style={{ fontFamily: "'Outfit', sans-serif", fontWeight: 800, fontSize: "16px" }}>{r.month}</div>
              </div>
              <div style={{ flex: 1 }}>
                  ...
                  <div style={{ display: "flex", flexWrap: "wrap", gap: "6px" }}>
                    {r.resources.map((res, j) => (
                      <span key={j} style={{
                        ...
                        color: "#fbcfe8", padding: "3px 10px", borderRadius: "6px", fontSize: "12px"
                      }}>🔗 {res}</span>
                    ))}
                  </div>
                )}
        ...
        <div style={{
          ...
          <h3 style={{ fontFamily: "'Outfit', sans-serif", fontSize: "24px", fontWeight: 800, marginBottom: "12px" }}>
